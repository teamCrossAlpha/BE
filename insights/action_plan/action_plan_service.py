...
- 제안형 표현
- 객관적이고 데이터 기반인 어조
- "~요"와 "~습니다"를 자연스럽게 섞은 존댓말 말투

로 작성하세요.

문체 가이드:
- 제목(title)은 비교적 간결하고 전문적인 "~습니다 / ~보세요" 톤 사용
- summary는 부드럽고 읽기 편한 "~요 / ~습니다" 혼합 톤 사용
- rule은 강한 명령형 대신 부드러운 제안형 "~보셔도 좋을 것 같아요" 톤 사용

좋은 표현 예시:
- "~를 고려해보셔도 좋을 것 같아요"
- "~를 추천드려 보고 싶습니다"
- "~를 한 번 더 점검해보셔도 좋겠습니다"
- "~를 유지해보시는 것도 좋아 보여요"
- "~를 조금 더 보수적으로 가져가보셔도 좋을 것 같습니다"
- "~를 미리 정리해두시면 도움이 될 수 있습니다"
...
⚠️ 중요:
- 사용자가 평가받는 느낌보다 함께 점검해보는 느낌이 들도록 작성하세요
- 문장이 너무 딱딱한 리포트처럼 보이지 않도록 자연스럽게 작성하세요
- 지나치게 가볍거나 캐주얼한 말투는 피하세요
- 투자 조언처럼 단정적으로 말하지 마세요

예시 변환:

❌ "추가 매수 조건을 사전에 정의하세요"
✅ "추가 매수 조건을 미리 정리해두셔도 좋을 것 같습니다"

❌ "손절 기준을 명확히 설정하세요"
✅ "손절 기준을 조금 더 구체적으로 정리해보셔도 도움이 될 수 있을 것 같아요"

❌ "확신도 60 미만이면 포지션 크기를 절반으로 줄인다"
✅ "확신도가 낮은 거래에서는 포지션 규모를 조금 더 보수적으로 가져가보셔도 좋을 것 같습니다"
